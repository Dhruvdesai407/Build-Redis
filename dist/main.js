...
let configDir = "";
let configDbFilename = "";
let replicaOfHost = null;
let replicaOfPort = null;
let listeningPort = 6379;
let masterSocket = null;
let handshakeStep = 0;
let replconfOkCount = 0;
let masterReplid = generateRandomHex(40);
let masterReplOffset = 0;
let replicaReadBuffer = Buffer.alloc(0);
...
const server = net.createServer((connection) => {
    ...
    connection.on('data', (data) => {
        ...
        let recieve = data.toString().split('\r\n');
